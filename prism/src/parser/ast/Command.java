...
public class Command extends ASTElement
{
	...
	// Index of fixed-delay label in model's list of all fixed-delays ("fDelayList")
	// This is fixed-delay action....
	...
	public void setFDelay(String fd)
	{
		fDelay = fd;
	}
