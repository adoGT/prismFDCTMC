...
public class SimulatorEngine
{
	...
	public double getTransitionProbability(int i, int offset) throws PrismException
	{
        ...
        /**
	 * Get the fd index of a transition within a choice, specified by its index/offset.
	 */
	public int getTransitionFDIndex(int i) throws PrismException
	{
		return getTransitionList().getChoice(i).getFdIndex();
	}
        
        /**
	 * Get the fd index of a transition within a choice, specified by its index/offset.
	 */
	public double getFDelay(int module, int index) throws PrismException
	{
            double val = 0;
            if(index>=0)
		val = modulesFile.getModule(module).getFDelayValue(index);
            return val;
	}
