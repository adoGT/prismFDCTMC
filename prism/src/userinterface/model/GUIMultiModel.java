...
public class GUIMultiModel extends GUIPlugin implements PrismSettingsListener
{
	...
	public void doEnables()
	{
		...
		computeTr.setEnabled(!computing && (handler.getParsedModelType() == ModelType.CTMC || handler.getParsedModelType() == ModelType.DTMC || handler.getParsedModelType() == ModelType.FDCTMC));
	...
	{
            System.out.println("TRANSIENT CALLEEEED!!!!");
		// Reset warnings counter 
		getPrism().getMainLog().resetNumberOfWarnings();
		// Do transient
