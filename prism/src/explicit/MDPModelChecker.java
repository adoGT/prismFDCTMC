...
//		System.out.println("REWARDS: " + mdpRewards + "\n\n");
		
		
//		MDPSimple mdpSimple = new MDPSimple(mdp.getNumStates());
//		
//		System.out.println("reading probs");
//		
//        int j=1;
//		Distribution dist;
//		String label;
//		Double prob;
//
//		//test how fast can be stored double values
//        Set<Double> test = new HashSet<Double>();
//		try
//        {
//        	// Open the file that is the first
//            // command line parameter
//            FileInputStream fstream = new FileInputStream("/home/xkorenc/Desktop/svn/ctmc_ta_synthesis/examples/synchronization/synchronization.brambora.probs.results.copy");
...
//            String temp1[];
//            strLine = br.readLine(); //throw away first line
//            strLine = br.readLine();
//            
//            while (strLine!=null) {	            
//            	temp1 = strLine.split(" ");
...
//                prob = Double.parseDouble(temp1[1]);
//        		dist.add(1, 1- prob);
//        		dist.add(2, prob);
//        		mdpSimple.addActionLabelledChoice(0, dist, label);
////                test.add(prob);
////                System.out.println("\t[n" + j + "] (s=0) -> (1 - " + temp1[1] +"): (s'=2) + " + temp1[1] + ": (s'=3);");
//                j++;
//            	strLine = br.readLine();
//            	if(j%10000==0) System.out.println("Processing line :" + j);
//            }
...
//        dist = new Distribution();
//		dist.add(0, 1.0);
//		mdpSimple.addActionLabelledChoice(1, dist, "f1");
//
//        dist = new Distribution();
//		dist.add(2, 1.0);
//		mdpSimple.addActionLabelledChoice(2, dist, "d1");
//		
////		System.out.println("mdpSimple: "+ mdpSimple+ "\n\n");
//		
//		
//		mdp=mdpSimple;
//		
//		System.out.println("finished reading probs");
//
//		MDPRewardsSimple mdpRewardsSimple = new MDPRewardsSimple(mdp.getNumStates());
//
//		System.out.println("reading rewards");
//		
//        j=0;
//        Double cost;
//        try
...
//        	// Open the file that is the first
//            // command line parameter
//            FileInputStream fstream = new FileInputStream("/home/xkorenc/Desktop/svn/ctmc_ta_synthesis/examples/synchronization/synchronization.brambora.costs.results.copy");
//            // Get the object of DataInputStream
//            DataInputStream in = new DataInputStream(fstream);
//            BufferedReader br = new BufferedReader(new InputStreamReader(in));
//            String strLine;
...
//                label = "n" + j;
//                dist = new Distribution();
//                cost = Double.parseDouble(temp1[1]);
//                mdpRewardsSimple.addToTransitionReward(0, j, cost);
//                j++;
//            	strLine = br.readLine();
//            	if(j%10000==0) System.out.println("Processing line :" + j);
//            }
...
//        }
//		
//		mdpRewardsSimple.addToTransitionReward(1, 0, 1.0);
//		mdpRewardsSimple.addToTransitionReward(2, 0, 0.0);
//		
////		System.out.println("mdpRewardsSimple: " + mdpRewardsSimple + "\n\n");
//		
//		mdpRewards = mdpRewardsSimple;
//
//		System.out.println("finished reading reawards");
